...
\definepapersize[slidepage][width=78mm,height=117mm]
\ifnotes  \setuppapersize[A4][A4] \fi
\ifslides \setuppapersize[slidepage,landscape][slidepage,landscape] \fi
...
\definemixedcolumns [footnotecolumns] [n=2, balance=yes, distance=24pt, separator=rule,
                                      rulethickness=.5pt, rulecolor=gray, maxwidth=18cm]
\setcounter         [userpage] [1]
\setupfooter        [state=start]
\setupfootnotes[bodyfont=\footsize,location=text,width=20cm]
...
\else
  \def\footnoteblock{\blank[big]\startfootnotecolumns\placefootnotes\stopfootnotecolumns}
  \setuphead[section]
            [style={\switchtobodyfont[\sectionsize]},
             before={\footnoteblock\blank[2*big]},
             margin=3cm,
             after={\incrementcounter[slidenum]\blank[10pt]},
             aftersection={}]

  \setuphead[subsection]
            [style={\switchtobodyfont[\subsectionsize]},
             before={\footnoteblock\blank[10pt]},
             after={\incrementcounter[slidenum]\blank[big]},
             align=right,
             margin=0pt,
             sectionstarter=]
...
\setupfloat[slideflt][inner={\vskip-4.5mm\notefont}]
...
\setupsidebar[distance=-0.5mm,rulecolor=darkgray]
\setupdelimitedtext[blockquote][leftmargin=3mm,rightmargin=no]
