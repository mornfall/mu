...
\def\subsubsectionsize{11pt}
\def\bodysize{11pt}
\def\listsize{9.4pt}
\ifslides \def\codesize{9.2pt} \fi
\ifnotes  \def\codesize{8pt} \fi
\def\notesize{8.6pt}
\def\footsize{6.4pt}
...
\else
  ...
  \setuphead[subsection]    [style={\switchtobodyfont[\subsectionsize]}, before={\blank[6pt]},
                             after={\vskip-4pt}]
  \setuphead[subsubsection] [style={\switchtobodyfont[\subsubsectionsize]}, after={\vskip-6pt}]
\fi
...
\ifnotes \setupitemize[width=16pt, before={\blank[4pt]}, after={\blank[2pt]}] \fi
