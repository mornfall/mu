...
\else
  \setuphead[section]       [style={\switchtobodyfont[\sectionsize]},after={\incrementcounter[slidenum]\blank[10pt]}]
  \setuphead[subsection]    [style={\switchtobodyfont[\subsectionsize]}, before={\blank[8pt]},
                             after={\incrementcounter[slidenum]\blank[big]}, align=right, sectionstarter=]
